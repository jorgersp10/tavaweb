    ...
    <div class="container-fluid">
        ...
        <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h2>Liquidación de salarios</h2><br/>                     
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('recibo_funcionario.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">                               
                        @csrf
                        <div class="form-group row">
                            <div class="col-md-4">
                        ...
                        <!-- <div class="row mb-4">
                            ...
                            <div class="col-sm-6">
                                <input readonly type="text" id="salario_basico" name="salario_basico" class="form-control number1">
                            </div>
                        </div> -->
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="horas_extra" name="horas_extra" class="form-control number3">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="comisiones" name="comisiones" class="form-control number4">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="otros_ingre" name="otros_ingre" class="form-control number5">
                            </div>
                        </div>
                        ...
                        <!-- <div class="row mb-4">
                            ...
                            <div class="col-sm-6">
                                <input readonly type="text" id="ips" name="ips" class="form-control">
                            </div>
                        </div> -->
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="otros_desc" name="otros_desc" class="form-control number6" onBlur="salarioFinal()">
                            </div>
                        </div>
                        ...
                        <!-- <div class="row mb-4">
                            ...
                            <div class="col-sm-6">
                                <input readonly type="text" id="salario_cobrar" name="salario_cobrar" class="form-control number7">
                            </div>
                        </div> -->

                        <div class="row mb-4">
                            <label for="horizontal-firstname-input" class="col-sm-2 col-form-label">Mes de Pago</label>
                            <div class="col-sm-6">

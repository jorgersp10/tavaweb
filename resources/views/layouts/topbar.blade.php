<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            <!-- LOGO -->
            <div class="navbar-brand-box md-4">
                <a href="https://tava.labprof.net/tava/public/" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset ('/assets/images/logo-cope.jpg') }}" alt="" height="15">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('/assets/images/logo-cope.jpg') }}" alt="" height="15">
                    </span>
                ...
                <a href="https://tava.labprof.net/tava/public/" class="logo logo-light">
                    <span class="logo-sm">
                        <img class="center">
                    </span>
                    <span class="logo-lg">
                        <img class="center" src="{{ URL::asset ('/assets/images/generico.png') }}" width="200" height="75">
                    </span>
                </a>
            </div>
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item d-block" href="#" data-bs-toggle="modal" data-bs-target=".change-password"><i class="bx bx-wrench font-size-16 align-middle me-1"></i> <span key="t-settings">@lang('Cambiar contraseña')</span></a>
                ...
                <a class="dropdown-item text-danger" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span key="t-logout">@lang('Cerrar Sesion')</span></a>
                ...
                <form method="POST" id="change-password">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="current-password" type="password"
                            ...
                            placeholder="Ingrese contraseña actual" value="{{ old('current_password') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="password" type="password"
                            ...
                            autocomplete="new_password" placeholder="Ingrese contraseña nueva">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation"
                            autocomplete="new_password" placeholder="Confirmar contraseña nueva">

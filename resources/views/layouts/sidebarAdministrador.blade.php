            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li>
                            <a class="waves-effect"  href="{{url('transfer/create')}}" onclick="event.preventDefault(); document.getElementById('transfer/create-form').submit();">
                            <span>Transferencia</span></a>
                            <form id="transfer/create-form" action="{{url('transfer/create')}}" method="GET" style="display: none;">
                                {{csrf_field()}} 
                            </form> 
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a class="waves-effect"  href="{{url('informeLibroVenta')}}" onclick="event.preventDefault(); document.getElementById('informeLibroVenta-form').submit();">
                            <span>Libro IVA Ventas</span></a>
                            <form id="informeLibroVenta-form" action="{{url('informeLibroVenta')}}" method="GET" style="display: none;">
                                {{csrf_field()}} 
                            </form> 
                        </li>
                 ...
                 <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-invoices">Admin. de Sistema</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a class="waves-effect"  href="{{url('timbrado')}}" onclick="event.preventDefault(); document.getElementById('timbrado-form').submit();">
                            <span>Timbrado Factura</span></a>
                            <form id="timbrado-form" action="{{url('timbrado')}}" method="GET" style="display: none;">
                                {{csrf_field()}} 
                            </form> 
                        </li>
                        <li><a class="waves-effect"  href="{{url('cajero')}}" onclick="event.preventDefault(); document.getElementById('cajero-form').submit();">
                            <span>Cajero</span></a>
                        ...
                        <!-- <li class="nav-item">
                            <a class="waves-effect" href="{{url('sucursal')}}" onclick="event.preventDefault(); document.getElementById('sucursal-form').submit();">

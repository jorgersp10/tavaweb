        ...
        <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" id="endosante_id_hidden" name="endosante_id_hidden"  value="{{$cheques->endosante_id}}">
                        ...
                        <input type="hidden" id="tipo_cheque_id_hidden" name="tipo_cheque_id_hidden"  value="{{$cheques->tipo_cheque_id}}">
                            ...
                            <div class="row mb-2">
                                    ...
                                    <input readonly type="text" class="form-control" id="cuenta_corriente" name="cuenta_corriente" value="{{$cheques->cuenta_corriente}}" placeholder="Ingrese número de cuenta">
                             ...
                             <div class="form-group row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                    <label class="col-md-5 form-control-label" for="tipo_cheque">Librador</label>
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    <label class="col-md-5 form-control-label" for="endosante">Endosante</label>
                                    <div class="mb-3">
                                        <input readonly type="text" id="endosante" name="endosante" value="{{$cheques->endosante}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">

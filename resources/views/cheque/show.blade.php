    ...
    <main class="main">
        ...
        <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('cheque.update','test')}}" method="post" class="form-horizontal" enctype="multipart/form-data">                             
                        {{method_field('patch')}}
                        @csrf
                        ...
                        <input type="hidden" id="tipo_cheque_id_hidden" name="tipo_cheque_id_hidden"  value="{{$cheques->tipo_cheque_id}}">
                            ...
                            <div class="row mb-2">
                                    ...
                                    <input type="text" class="form-control" id="cuenta_corriente" name="cuenta_corriente" value="{{$cheques->cuenta_corriente}}" placeholder="Ingrese número de cuenta">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="endosante_id" id="endosante_id" onchange="obtenerComentarioEnd()" style= "width:300px">
                                            ...
                                            <option value="{{$cheques->endosante_id}}">{{$cheques->endosante}} </option> 

        ...
        <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                       <h2>Lista de Cheques Recibidos</h2><br/>
                       @if(session()->has('msj'))
                            ...
                            <div class="table-responsive mb-0" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table table-striped">                               
                                    <thead>                            
                                            ...
                                            <th  data-priority="1">Endosante</th>
                                    ...
                                    <tbody>
                                         ...
                                         @foreach($cheques as $c)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{URL::action('App\Http\Controllers\ChequeController@edit', $c->id)}}">
                                                ...
                                                <td>
                                                    <a href="{{URL::action('App\Http\Controllers\ChequeController@show', $c->id)}}">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="form_mora" action="{{route('cobrarChequeR')}}" method="POST">
                            {{csrf_field()}} 

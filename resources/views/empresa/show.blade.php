...
<main class="main">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('empresa.update','test')}}" method="post" class="form-horizontal" enctype="multipart/form-data">                             
                             {{method_field('patch')}}
                        @csrf
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    <input type="text" id="nombre" name="nombre" value="{{$empresas->nombre}}" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label class="col-md-3 form-control-label" for="precio">RUC</label>
                                <div class="mb-3">
                                    <input type="text" id="ruc" name="ruc" class="form-control" value="{{$empresas->ruc}}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label class="col-md-3 form-control-label" for="precio">Dirección</label>
                                <div class="mb-3">
                                    <input type="text" id="direccion" name="direccion" class="form-control" value="{{$empresas->direccion}}">
                                </div>
                            </div>
                        </div>
